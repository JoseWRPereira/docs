...
|   2    | 31/07 | [Saídas Digitais](../../digitais/Controladores/arduino/uno01-digital_output.md) e Sequenciais Industriais<br>- T: Registradores de direção (`DDRx`) e dados (`PORTx`); conceitos de corrente máxima por pino.<br>- P: Montagem de um sinalizador sequencial com 8 [LEDs](../../digitais/Perifericos/dio01-led.md) (simulando status de processo)   | - Exposição Dialogada<br>- Prática orientada |     |
|   3    | 07/08 | [Entradas Digitais](../../digitais/Controladores/arduino/uno02-digital_input.md) e o Problema do Bounce<br>- T: Leitura de [botões](../../digitais/Perifericos/dio02-button.md) (`PINx`); resistores de _pull-up_ internos; ruído mecânico (_bounce_);<br>- P: Acionamento de uma carga (LED) por botão com tratamento de _debounce_ via software.   | - Exposição Dialogada<br>- Prática orientada |     |
